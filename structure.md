...
│   ├── ai_engine.py         # Advanced Inference Engine (SciSpacy + HGBDT + Groq GPT OSS 120B)
...
- **Clinical Reasoning**: Integrated with `GPT OSS 120B` (via Groq) for nuanced medical advice.
...
5. **Enrichment**: GPT OSS 120B provides additional clinical context and preventative advice.
