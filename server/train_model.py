...
# Decision Tree (HGBDT) classifier.
#
# ## 🧠 Model Architecture:
# - Core: HistGradientBoostingClassifier (Scikit-Learn).
# - Strategy: Mixed-feature learning (Binary Symptoms + Normalized Numerical Vitals).
# - Regularization: L2 decay + Depth constraints to prevent overfitting on clinical noise.
#
# ## 📈 Feature Engineering:
# - Vitals (Age, HR, BP) are normalized using StandardScaler to match the scale
#   of binary symptom vectors.
# - Clinical weighting: Red-flag cases (Heart Attack, Stroke) are oversampled 
#   15x to ensure high-sensitivity detection in life-threatening scenarios.
# ------------------------------------------------------------------------------
"""
...
def normalize_symptom(s: any) -> Optional[str]:
    """
    Sanitizes raw symptom strings into a machine-learning compatible format.
    
    Processing Steps:
    1. Type validation (must be string)
    2. Lowercasing for case-insensitivity
    3. Trimming leading/trailing whitespace
    4. Underscore substitution for space-separated tokens
    
    Example: " Chest Pain " -> "chest_pain"
    """
